...
Legenda: ✅ entregue · 🎯 pronto pra delegar · ⚡ paraleliza · 🔒 bloqueado · 🔀 consolidado em outra task
...
| **M2** | Preparação pro contrato do mmb-logger — schema/MSW/telas | ✅ entregue | [`M2-cockpit-preparacao.md`](M2-cockpit-preparacao.md) |
| **M3** | Filtro multiselect de andaime_version (épicos + ciclos) | 🎯 pronto pra delegar | [`M3-filtro-andaime-version.md`](M3-filtro-andaime-version.md) |
...
| ~~F5~~ | ~~Tela: Dashboard~~ | 🔀 absorvido por M1 | — |
