...
const PROJETO_ID = "10000000-0000-0000-0000-000000000001"; // mmb-core, tem fixture global de métricas
...
describe("ProjetoDetailPage", () => {
  ...
  it("renderiza 404 quando metricas retornam 404", async () => {
    // id fora dos projetoMetricasFixtures — handler global responde 404 sozinho.
